...
Dates of service - "03/05/2021-04/05/2021"
Date of loss - "07/13/2020"

Accident Information

Provided - The review is for patient {full name}, {DOB}, who was involved in an automobile on {date}, 
Needed:
wherein the claimant was the {restrained/unrestrained/neither - checkboxes} {driver/front seat passenger/LR/RR/rear seat passenger} of a vehicle that was
{struck/rear-ended on the front driver's side - text box}

Clinical Summary last sentence:

"The provider is requesting"
{CPT Code} - {CPT Code Name},
{CPT Code} - {CPT Code Name},
{CPT Code} - {CPT Code Name}, and {CPT Code} - {CPT Code Name}
, at a frequency of {x} visits per week for {y} weeks for the period of {start-date} through {end-date}.
...
"It is noted that the claimant has been approved for {x} PT visits from {start date} to {end date} and {y} chiropractic visits"
